...
class ProducerCLI {
	...
	static void printHelpAndExit(String emessage, Options options) {
		// Log the error, using the same configuration and files as ProducerMain
		Logger logger = LogManager.getLogger(ProducerCLI.class);
	    ...
	    formatter.printHelp(pw, 80, "producer", "", options, 0, 0, "");
