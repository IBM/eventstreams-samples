# eventstreams-samples/java-apache/02-sample/consumer
...
1. Run `mvn package`. This creates the executable jar file `target/consumer02-1.0.0.jar`.
2. Run `java -jar target/consumer02-1.0.0.jar [arguments...]`
